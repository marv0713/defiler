...
export const enMessages: MessageDictionary = {
  ...
  "start.heroSubtitle": "Plan and conquer. Write your Warring States legend through cards and tactics.",
  "start.yourFaction": "Your Faction",
  "start.opponentFaction": "Opponent (AI)",
  "start.quickBattle": "Quick Battle",
  "start.quickBattleDesc": "Enter a quick match with the selected factions.",
  "start.campaign": "Campaign",
  "start.campaignDesc": "Enter campaign chapters and level selection.",
  "common.vs": "VS",
  ...
  "hand.discardLabel": "Discard {card}",
  "hand.rowText": ", row: {row}",
  "game.round": "Small Round {round} / 3",
  "game.smallRound": "Small Round {round} / Best of Three",
  "game.activeSide": "{side}'s Turn",
  "game.roundOver": "Small Round Over",
  "game.gameStarted": "Game started",
  "game.yourTurn": "Choose a hand card to play, or pass this small round.",
  ...
  "game.cardDetails": "Card Details",
  "game.cardDetailsHint": "Hover or click a card to view its description and skills.",
  "game.restartMatch": "Restart Match",
  "game.exitToMainMenu": "Exit to Main Menu",
  "game.logRoundStarted": "Small Round {round} Started",
  "game.logPlayCard": "{player} played [{card}] (Power: {power}){effect}",
  "game.logPlayUnknown": "{player} played a card",
  "game.logEffectDamage": ", dealing {amount} damage",
  "game.logEffectBoost": ", gaining +{amount} boost",
  "game.logEffectSummon": ", summoning allies",
  "game.logEffectLock": ", locking an enemy",
  "game.logEffectRevive": ", reviving a unit",
  "game.logEffectDrawDiscard": ", drawing {draw} and discarding {discard}",
  "game.logEffectDestroy": ", destroying an enemy unit",
  "game.logEffectClearWeather": ", clearing weather",
  "round.title": "Small Round {round} Over",
  "round.playerWon": "You won this small round!",
  "round.opponentWon": "Opponent won this small round.",
  "round.draw": "This small round is drawn — no wins awarded.",
  "round.startNext": "Start Small Round {round}",
  ...
  "faction.qin.battleStyle": "Style: Direct Power | Trait: Domination. Exerts high front-line point pressure.",
  "faction.chu.battleStyle": "Style: Token Summoning | Trait: Swarm. Prolifically spawns token units onto rows.",
  "faction.qi.battleStyle": "Style: Card Advantage | Trait: Tactician. Excels at card draws and row hand buffers.",
  "faction.zhao.battleStyle": "Style: Comeback | Trait: Resurgence. Bursts massive points when trailing or in later rounds.",
  "faction.qin.styleTag": "Direct Pressure",
  "faction.chu.styleTag": "Summon Swarm",
  "faction.qi.styleTag": "Hand Tactics",
  "faction.zhao.styleTag": "Comeback Burst",
  "faction.qin.beginnerTag": "★ Beginner",
  "faction.chu.beginnerTag": "★★ Intermediate",
  "faction.qi.beginnerTag": "★★★ Advanced",
  "faction.zhao.beginnerTag": "★★ Intermediate",
  "policy.qin.name": "Tiger-Wolf Host",
  "policy.chu.name": "Summons",
  "policy.qi.name": "Jixia Counsel",
  "policy.zhao.name": "Cavalry Reform",
  "policy.neutral.name": "Stratagem",
  ...
  // ── Campaign Page Keys ────────────────────────────────────────────────────
  "campaign.factionCards": "{count} cards in pool",
  "campaign.difficulty": "Difficulty",
  "campaign.routeTitle": "Campaign Route",
  "campaign.stageDetail": "Stage Details",
  "campaign.enemyMechanic": "Enemy Mechanic",
  "campaign.learningGoal": "Learning Goal",
  "campaign.startChallenge": "Start Challenge",
  "campaign.lockedReason": "Complete the previous stage to unlock.",
  "campaign.cleared": "Campaign cleared — all levels unlocked.",
  ...
  "game.youDiscard": "🔴 You discard",
  "game.discardTitle": "Choose a Card to Discard",
  "game.discardHint": "Select {count} card(s) from your hand to discard.",
  "game.discardConfirm": "Confirm",
  ...
  "deckbuilder.filterAll": "All",
  "deckbuilder.filterUnits": "Units",
  "deckbuilder.filterSpecials": "Specials",
  "deckbuilder.filterAddable": "Addable",
  "deckbuilder.sortDefault": "Default",
  "deckbuilder.sortPower": "Power ↓",
  "deckbuilder.statsUnits": "Units",
  "deckbuilder.statsSpecials": "Specials",
  "deckbuilder.statsMelee": "Melee",
  "deckbuilder.statsRanged": "Ranged",
  "deckbuilder.statsSiege": "Siege",
  "deckbuilder.avgPower": "Avg Power",
  "deckbuilder.stageGoal": "Goal",
  "deckbuilder.specialRule": "Special Rule",
  "deckbuilder.clearDeck": "Clear Deck",
  "deckbuilder.operationHint": "Click cards to add them to your deck. Click × to remove. Each card has a copy limit. Remove a card before replacing it.",
  "deckbuilder.needMoreCards": "Need {count} more cards",
  "deckbuilder.deckIllegal": "Deck illegal — see error below",
  "deckbuilder.errorNoLevel": "No level selected.",
  "deckbuilder.errorWrongSize": "Deck must contain exactly 25 cards (currently {count}).",
  "deckbuilder.errorDuplicates": "This level requires all 25 cards to be unique — remove duplicates.",
  "deckbuilder.errorWrongFaction": "Deck can only contain cards from your campaign faction.",
  "deckbuilder.errorTooManyCopies": "Too many copies of \"{card}\" (max {max} allowed).",
  ...
  "level.level-1-iron-wall.mechanic": "Pure Qin power cards with no effects — teaches basic point comparison.",
  "level.level-1-iron-wall.goal": "Learn card play, score calculation, and Pass timing without skill interactions.",
  "level.level-2-swarm.mechanic": "Chu SUMMON effects flood the board with tokens — requires board presence to answer.",
  "level.level-2-swarm.goal": "Learn to counter token swarms with efficient removal and higher board power.",
  "level.level-3-scholar.mechanic": "Qi DRAW_DISCARD generates card advantage — outlasts you if you over-spend early.",
  "level.level-3-scholar.goal": "Learn to manage limited copies across factions and conserve resources strategically.",
  "level.level-4-comeback.mechanic": "Zhao CONDITIONAL_BOOST bursts when behind — deliberately concedes round 1 then explodes.",
  "level.level-4-comeback.goal": "Learn comeback awareness: conserve cards for round 2 and close the match before round 3.",
  "level.level-5-coalition.mechanic": "Elite units mixed from Qin, Chu, Qi, and Zhao — no obvious faction weakness.",
  "level.level-5-coalition.goal": "Learn to build a focused single-faction deck strong enough to handle varied threats.",
  "level.level-6-apex.mechanic": "The strongest Qin deck with Normal AI at peak — no player restrictions, maximum pressure.",
  "level.level-6-apex.goal": "Apply everything learned. Build your strongest deck and defeat the ultimate challenge.",

  // ── Glossary Text ─────────────────────────────────────────────────────────
  "glossary.title": "Mechanics Glossary",
  "glossary.keywordTitle": "Keyword Explanations",
